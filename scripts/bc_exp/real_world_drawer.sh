# aug64, TS0, save every 5000 steps, max20000steps
# D4 planner3
python main.py --env=close_loop_block_in_bowl --num_obj=1 --num_processes=5 --num_eval_process=1 --render=f\
                ...
                --load_buffer=/home/mingxi/ws/equi_close_loop_new/BC/equi_close_loop/scripts/outputs/buffer/drawer_4epi.npy --load_n=3\
...
python main.py --env=close_loop_block_in_bowl --num_obj=1 --num_processes=5 --num_eval_process=1 --render=f\
                ...
                --equi_n=4 --n_hidden=64 --batch_size=64 --buffer=aug --buffer_aug_n=64 --lr=1e-3 --gamma=0.99 --seed=1 --transparent_bin=t \
                --max_train_step=20000 --simulate_n=0 --eval_freq=-1 --save_multi_freq=5000 --num_eval_episodes=1 --robot=kuka --sigma=0.4 --view_type=render_center\
                --load_buffer=/home/mingxi/ws/equi_close_loop_new/BC/equi_close_loop/scripts/outputs/buffer/drawer_4epi.npy --load_n=2\
...
python main.py --env=close_loop_block_in_bowl --num_obj=1 --num_processes=5 --num_eval_process=1 --render=f\
                ...
                --equi_n=4 --n_hidden=64 --batch_size=64 --buffer=aug --buffer_aug_n=64 --lr=1e-3 --gamma=0.99 --seed=1 --transparent_bin=t \
                --max_train_step=20000 --simulate_n=0 --eval_freq=-1 --save_multi_freq=5000 --num_eval_episodes=1 --robot=kuka --sigma=0.4 --view_type=render_center\
                --load_buffer=/home/mingxi/ws/equi_close_loop_new/BC/equi_close_loop/scripts/outputs/buffer/drawer_4epi.npy --load_n=1\
