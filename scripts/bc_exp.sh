...
python mytest.py --log_sub="push_dpos0.02_drot_n4_simulate_n4_sim_sigma0.2_ws0.3" --workspace_size=0.3 --env=close_loop_block_pushing --num_obj=1 --num_processes=1 --num_eval_process=5 --render=f --max_episode_steps=50 --planner_episode=20 --dpos=0.02 --drot_n=4 --alg=bc_con --model=equi --equi_n=4 --n_hidden=64 --batch_size=64 --buffer=aug --lr=1e-3 --gamma=0.99 --seed=1 --sigma=0.2 --max_train_step=2000 --simulate_n=4 --eval_freq=500 --robot=panda
