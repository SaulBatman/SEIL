...
class EquFCN(torch.nn.Module):
    def __init__(self, n_input_channel=1, n_output_channel=1, N=8,
        ...
        self.net = torch.nn.Sequential(
            EquResUNet(n_input_channel=n_input_channel, n_output_channel=n_middle_channels[0],
            ...
            nn.R2Conv(nn.FieldType(self.r2_act, n_middle_channels[0] * [self.repr]),
                      nn.FieldType(self.r2_act, n_output_channel * [self.r2_act.trivial_repr]), kernel_size=1,
