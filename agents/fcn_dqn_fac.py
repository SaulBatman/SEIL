...
class FCNDQNFac(FCNBase):
    ...
    def getEGreedyActions(self, state, obs, eps):
        with torch.no_grad():
            ...
            dxy_id = torch_utils.argmax2d(q_dxy)
    ...
    def calcTDLoss(self):
        ...
        with torch.no_grad():
            ...
            q_dxy_prime = q_dxy_prime.reshape(batch_size, -1)
        ...
        q_dxy_pred = q_dxy[torch.arange(batch_size), dxy_id[:, 0], dxy_id[:, 1]]
